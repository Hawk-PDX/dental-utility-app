    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/register/doctor"
              className="px-8 py-4 text-lg font-semibold bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors shadow-lg"
            >
              Start as a Doctor
            </Link>
            <Link
              href="/register/patient"
              className="px-8 py-4 text-lg font-semibold bg-white text-blue-600 border-2 border-blue-600 rounded-lg hover:bg-blue-50 transition-colors"
            >
              Join as a Patient
            </Link>
          </div>
      ...
      <section className="bg-blue-600 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link
            href="/register/doctor"
            className="inline-block px-8 py-4 text-lg font-semibold bg-white text-blue-600 rounded-lg hover:bg-gray-100 transition-colors shadow-lg"
          >
            Get Started Today
          </Link>
        </div>
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-lg font-bold text-white">DentalHub</span>
              </div>
              <p className="text-sm">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <a href="mailto:support@dentalhub.com" className="hover:text-white transition-colors">
                    Contact Support
                  </a>
                </li>
                <li>
